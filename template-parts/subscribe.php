<section class="social-sec">
    <div class="container">
        <div class="slider-inner">
            <?php if (get_sub_field('title','option') && get_sub_field('instalink','option') && get_sub_field('instaname','option')): ?>
                <div data-aos="fade-up">
                    <h2><?php the_sub_field('title','option'); ?> <br> <a href="<?php the_sub_field('instalink','option'); ?>"><?php the_sub_field('instaname','option'); ?></a>
                    </h2>
                </div>
            <?php endif; ?>
